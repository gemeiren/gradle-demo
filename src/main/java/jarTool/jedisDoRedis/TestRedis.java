...
public class TestRedis {
    ...
    public  void setup() {
        ...
        jedis = new Jedis("10.199.169.237", 6379);
        //权限认证
        //jedis.auth("admin");  
       // System.out.println("连接redis服务器over");
    }
    ...
    public void testString() {
        ...
        System.out.println("1-----"+jedis.get("name"));//执行结果：xinxin  
    ...
    public void testList(){  
        ...
        //先向key java framework中存放三条数据    左边压栈
    ...
    public void testSet(){  
        //添加  
    	jedis.del("user");//测试时先删除前面的缓存，再进行添加key
    ...
    public void testRedisPool() {
        ...
        System.out.println("从缓存获取数据："+RedisUtil.getJedis().get("newname"));
    }
}