 ...
 * @Description : .StreamTokenizer 类，这个类非常有用，
 * 它可以把输入流解析为标记（token）, StreamTokenizer 并非派生自InputStream或者OutputStream，
 * 而是归类于io库中，因为StreamTokenizer只处理InputStream 对象。s
 * @Date: 2017年4月2日 上午10:44:23
 */
/** 
