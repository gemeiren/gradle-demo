...
/**
 * @Description : https://blog.csdn.net/tyyking/article/details/53690291
 * @Date: 2018年5月20日 下午10:05:27
 */
public class CustomStringUtil {
	...
	public static String getExtension() throws Exception {
	  ...
	  * @throws Exception
	  */
	public static String getArrayToString(Object[] array, String separator)
			throws Exception {
